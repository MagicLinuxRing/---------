...
namespace ForKids.DB.OleDbDAL
{
	...
	/// 数据访问类:GRADEBASE
	/// </summary>
	public partial class GRADEBASE:IGRADEBASE
	{
		public GRADEBASE()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperOleDb.GetMaxID("ID", "GRADEBASE"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from GRADEBASE");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update GRADEBASE set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from GRADEBASE ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
		...
		public ForKids.DB.Model.GRADEBASE GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,NAME,HEADTEACHERID,TUITION,DESCRIPTION from GRADEBASE ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
			...
			ForKids.DB.Model.GRADEBASE model=new ForKids.DB.Model.GRADEBASE();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["TUITION"]!=null && ds.Tables[0].Rows[0]["TUITION"].ToString()!="")
				{
					model.TUITION=int.Parse(ds.Tables[0].Rows[0]["TUITION"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,NAME,HEADTEACHERID,TUITION,DESCRIPTION ");
			strSql.Append(" FROM GRADEBASE ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from GRADEBASE T ");
