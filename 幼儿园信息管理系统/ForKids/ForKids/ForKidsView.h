...
// ForKidsView.h : CForKidsView 类的接口
//
...
inline CForKidsDoc* CForKidsView::GetDocument() const
   { return reinterpret_cast<CForKidsDoc*>(m_pDocument); }
#endif
