...
namespace ForKids.DB.OleDbDAL
{
	...
	/// 数据访问类:COURSEBASE
	/// </summary>
	public partial class COURSEBASE:ICOURSEBASE
	{
		public COURSEBASE()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperOleDb.GetMaxID("ID", "COURSEBASE"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from COURSEBASE");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into COURSEBASE(");
			strSql.Append("NAME,GRADEID,DESCRIPTION)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update COURSEBASE set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from COURSEBASE ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
		...
		public ForKids.DB.Model.COURSEBASE GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,NAME,GRADEID,DESCRIPTION from COURSEBASE ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
			...
			ForKids.DB.Model.COURSEBASE model=new ForKids.DB.Model.COURSEBASE();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,NAME,GRADEID,DESCRIPTION ");
			strSql.Append(" FROM COURSEBASE ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from COURSEBASE T ");
