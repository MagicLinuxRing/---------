...
namespace ForKids.Util.WindowsAPI
{
    public class NativeMethods
    {
        ...
        [DllImport("Kernel32.dll", EntryPoint = "WritePrivateProfileString", CharSet = CharSet.Unicode, BestFitMapping = false, ThrowOnUnmappableChar = true)]
        ...
        [DllImport("Kernel32.dll", EntryPoint = "GetPrivateProfileInt", CharSet = CharSet.Unicode, BestFitMapping = false, ThrowOnUnmappableChar = true)]
        ...
        [DllImport("Kernel32.dll", EntryPoint = "GetPrivateProfileString", CharSet = CharSet.Unicode, BestFitMapping = false, ThrowOnUnmappableChar = true)]
        ...
        [DllImport("user32.dll")]
        public static extern IntPtr SetCapture(IntPtr hwnd   /* handle to window*/);
